...
**Data de implantação**: 22 de maio de 2026
...
>[!NOTE]
>
>Essas alterações de versão começam a ser implantadas em 22 de maio de 2026, com uma implantação em fases de cada recurso e aprimoramento. As datas de lançamento de recursos e melhorias estão sujeitas a alterações.
...
| Recurso | Ações de conta e grupo de compra | Realize ações diretamente nas páginas de detalhes da conta e detalhes do grupo de compra para um engajamento oportuno e intencional. <li>Use a ação _Enviar email_ para enviar um email do Marketo Engage aprovado para contatos de conta ou membros do grupo de compra selecionados. [Saiba mais](../accounts/account-details.md#send-email) <li>Nos detalhes do grupo de compra, as ações também incluem as opções _Atribuir um novo membro_, _Remover um membro_ e _Editar uma função_. [Saiba mais](../buying-groups/buying-group-details.md#members-tab) |
