...
| Público-alvo da conta | Esse componente fornece a resposta para: <ul><li>Para quem você está vendendo?</li><li>Qual é a lista de contas que você está direcionando?</li></ul> **_Example:_** Segmento de conta definido por contas com o Produto Y com receita superior a 1 milhão |
...
3. **_Processos do sistema_**: processos de [criação](../buying-groups/buying-groups-create.md#buying-group-creation-jobs) e manutenção de grupo de compras.

Para evitar a substituição incorreta da atribuição de um membro em um grupo de compra, essa lista está na ordem de precedência seguida no sistema com o objetivo de garantir uma atribuição de membros precisa. Por exemplo, quando um usuário de vendas adiciona manualmente um membro ao grupo de compra, ele não deseja que um processo de manutenção altere essa adição. Usando a ordem de precedência, os seguintes cenários são aplicados:

* Se um usuário atribuir manualmente um membro a um grupo de compra e isso for seguido por um processo de manutenção de grupo de compra que o remove, o processo de manutenção **não removerá** esse membro e não poderá se sobrepor à atribuição manual.
...
* Se um nó de ação de jornada acionado adicionar um membro a um grupo de compra e isso for seguido por um processo de manutenção de grupo de compra que o remove, o processo de manutenção **não removerá** esse membro e não poderá se sobrepor à atribuição de ação de jornada.
...
| [!UICONTROL Interesses de solução] | Essa guia oferece suporte às seguintes atividades: <ul><li>Exibir a lista de grupos de compra existentes. </li><li>Pesquisar por nome do grupo de compra. </li><li>Acessar e editar as propriedades de interesse de solução. </li><li>Criar um interesse de solução. </li><li>Excluir um interesse de solução. </li><li>Processos de exibir e excluir grupos de compra. </li></ul> |
