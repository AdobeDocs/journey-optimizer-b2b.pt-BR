...
description: Visualize os detalhes do grupo de compras com insights alimentados por IA, gerencie funções de membro, rastreie pontuações de engajamento e analise dados de intenção no Journey Optimizer B2B edition.
