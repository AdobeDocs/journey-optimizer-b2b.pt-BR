---
title: Painel de insights da função
description: Saiba mais sobre o painel de Insights da função que rastreia a aquisição de funções e o envolvimento em grupos de compra no Journey Optimizer B2B edition.
...
![Painel de insights da função](assets/roles-insights-dashboard.png){width="800" zoomable="yes"}
...
![Caixa de diálogo de Filtros para Insights de Funções](./assets/roles-insights-filter-dialog.png){width="400"}
...
![Painel de insights da função - Aquisição de função ao longo do tempo gráfico](assets/roles-insights-role-aquisition-over-time.png){width="600" zoomable="yes"}
...
![Painel de insights da função - Gráfico de participação por função](assets/roles-insights-engagement-by-role.png){width="500" zoomable="yes"}
...
![Painel de insights da função - Gráfico de envolvimento por função ao longo do tempo](assets/roles-insights-engagement-by-role-over-time.png){width="500" zoomable="yes"}
