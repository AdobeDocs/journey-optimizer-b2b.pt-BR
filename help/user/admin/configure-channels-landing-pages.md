...
description: Configure subdomínios e predefinições de página de destino para que os profissionais de marketing possam publicar páginas de destino no Journey Optimizer B2B edition.
...
>abstract="Configure um subdomínio para uso da landing page. Você pode usar um subdomínio que já tenha sido delegado à Adobe ou configurar outro subdomínio."

>[!CONTEXTUALHELP]
>id="ajo-b2b_admin_subdomain_lp"
>title="Delegar um subdomínio de página de destino"
>abstract="É necessário configurar um subdomínio de página de aterrissagem antes de criar uma predefinição de página de aterrissagem. Você pode usar um subdomínio já delegado à Adobe ou configurar um novo subdomínio."

>[!CONTEXTUALHELP]
>id="ajo-b2b_admin_config_lp_subdomain"
>title="Criar uma predefinição de página de destino"
>abstract="Para criar uma predefinição de página de aterrissagem, verifique se você tem pelo menos um subdomínio de página de aterrissagem configurado para escolher na lista Nome de subdomínio."
...
![Configurações de canal - subdomínios de página de aterrissagem](./assets/config-channels-landing-pages-subdomains.png){width="800" zoomable="yes"}
...
1. Especifique o subdomínio que será delegado.
   ...
   ![Subdomínio da página de aterrissagem configurado](./assets/config-channels-landing-pages-subdomain-setup.png){width="500" zoomable="yes"}
...
1. Verifique se o registro DNS foi gerado na solução de hospedagem de domínio.
   ...
   ![Subdomínio da página de aterrissagem configurado com registros DNS](./assets/config-channels-landing-pages-subdomain-setup-dns.png){width="500" zoomable="yes"}
...
>title="Criar uma predefinição de página de destino"
>abstract="Para criar uma página de aterrissagem e aproveitá-la por meio do Journey Optimizer B2B edition, é necessário criar uma predefinição de página de aterrissagem que inclua o subdomínio que será usado."

Quando os profissionais de marketing [criam uma página de aterrissagem](../content/landing-pages-create-publish.md#create-landing-page), eles devem selecionar uma predefinição de página de aterrissagem para poder criar a página de aterrissagem e aproveitá-la por meio de [!DNL Journey Optimizer B2B Edition]. A predefinição inclui o subdomínio a ser usado para a página de aterrissagem.
...
![Configurações de canal - predefinições de página de aterrissagem](./assets/config-channels-landing-pages-presets.png){width="800" zoomable="yes"}
...
1. Selecione um subdomínio de landing page.
   ...
   ![Predefinição de página de aterrissagem com nome, descrição e subdomínio](./assets/config-channels-landing-pages-preset-create.png){width="500" zoomable="yes"}
...
1. Você pode selecionar o subdomínio da página de aterrissagem para a **[!UICONTROL URL de Acompanhamento]** marcando a opção **[!UICONTROL Igual ao subdomínio da página de aterrissagem]**.<!-- [Learn more about tracking](../email/message-tracking.md) -->
   ...
   ![Predefinição de página de aterrissagem com configurações de subdomínio](./assets/config-channels-landing-pages-preset-subdomain-settings.png){width="500" zoomable="yes"}
...
1. Clique em **[!UICONTROL Enviar]** para confirmar a criação da predefinição de página de destino.
   ...
   Quando criada, a predefinição de página de aterrissagem é exibida na lista com o status _[!UICONTROL Ativo]_ e está pronta para uso para [criar páginas de aterrissagem](../content/landing-pages-create-publish.md#create-landing-page).
