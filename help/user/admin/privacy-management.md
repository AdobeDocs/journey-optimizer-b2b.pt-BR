...
Você pode enviar solicitações individuais para acessar e excluir dados do consumidor de [!DNL Adobe Journey Optimizer B2B Edition] de duas maneiras:
...
[!DNL Journey Optimizer B2B Edition] dá suporte a dois tipos de solicitação de privacidade:
...
![Ícone de Permissões](../assets/do-not-localize/icon_permissions-outline.svg) Essas etapas exigem o perfil de produto [!DNL Privacy Service] e as [permissões a seguir para a função de usuário atribuída no Experience Platform](./user-management.md):
...
Para exibir os trabalhos de solicitação de privacidade em [!DNL Journey Optimizer B2B Edition], expanda **[!UICONTROL Privacidade]** e selecione **[!UICONTROL Solicitações]**.
...
1. Selecione **[!UICONTROL Criar Solicitação]**.

1. Para o **[!UICONTROL Tipo de Trabalho]**, selecione o tipo de solicitação:

   * **[!UICONTROL Acesso]**

     Quando você envia uma solicitação de **_acesso_** que inclui [!DNL Journey Optimizer B2B Edition], [!DNL Privacy Service] retorna:

     * [!DNL Marketo Engage] atividade associada ao cliente potencial.
     * Atividade [!DNL Journey Optimizer B2B Edition] associada à pessoa ou conta.

   * **[!UICONTROL Excluir]**

     Quando você envia uma solicitação de **exclusão** para [!DNL Marketo Engage] e [!DNL Journey Optimizer B2B Edition], os seguintes registros são removidos:

     * O lead associado em [!DNL Marketo Engage].
     * Registros de pessoa e conta criados em [!DNL Journey Optimizer B2B Edition].
     * Histórico de conversas do Assistente de IA que faz referência às informações pessoais da pessoa.
...
1. Para enviar a solicitação, selecione **[!UICONTROL Criar]**.
