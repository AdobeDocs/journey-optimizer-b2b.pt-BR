...
<tbody>
<tr>
<td colspan="2"><strong>Configurações XDM padrão</strong>: configurar o perfil individual XDM e os esquemas de conta comercial XDM.</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Caixa de seleção"/></td>
...
<tr>
<td colspan="2"><strong>Esquemas relacionais</strong>: selecione campos XDM relacionais (objeto personalizado muitos para um da conta).</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Caixa de seleção"/></td>
...
Para enviar emails de [!DNL Journey Optimizer B2B Edition], configure o rastreamento de email e a capacidade de entrega na instância de produção [!DNL Marketo Engage] anexada e no aplicativo [!DNL Journey Optimizer B2B Edition].
...
<td><a href="./admin/user-management.md#marketo-engage-profile">Saiba mais</a></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Caixa de seleção"/></td>
<td>Adicionar um grupo de usuários para o perfil</td>
<td><a href="./admin/user-management.md#add-user-group">Saiba mais</a></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Caixa de seleção"/></td>
