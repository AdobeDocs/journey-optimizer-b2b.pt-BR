...
* Para exibir os ativos por pasta, abra a estrutura clicando no ícone _Mostrar pastas_ na parte superior esquerda.
...
1. Na caixa de diálogo _[!UICONTROL Adicionar ativos]_, arraste e solte um ou mais arquivos do sistema na caixa de arquivo.
   ...
   ![Adicionar ativos a uma pasta](./assets/assets-add-dialog.png){width="500"}
...
1. Selecione a pasta de destino para armazenar os ativos.
...
Use um dos métodos a seguir para excluir um ativo:

* Vá para os detalhes do ativo, clique em **[!UICONTROL ... Mais]** no canto superior direito e escolha **[!UICONTROL Excluir]** nas opções.

  ![Acessar ações do ativo](./assets/assets-details-more-menu.png){width="450" zoomable="yes"}
...
No espaço de design visual, selecione o ícone do _Assets_ ( ![ícone do Assets](../../assets/do-not-localize/icon-assets-me.svg) ) na barra lateral esquerda.
...
* Adicione um componente de imagem à tela e clique em **[!UICONTROL Selecionar ativo]** no componente para abrir a caixa de diálogo _[!UICONTROL Selecionar ativo]_.
