...
Sua experiência na Web é ativada e se torna visível para o público-alvo quando você [publica a jornada](../journeys/create-publish-journey.md#publish-an-account-journey). Antes de ativar uma experiência da Web por meio de uma jornada, considere o seguinte:
