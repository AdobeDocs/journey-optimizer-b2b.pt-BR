...
>[!BEGINSHADEBOX &quot;Orientação sobre pixels de rastreamento de email&quot;]

Em 14 de abril de 2026, a *Commission nationale de l&#39;informatique et des libertés* (CNIL), autoridade de proteção de dados da França, publicou uma [recomendação sobre o uso de pixels de rastreamento em emails](https://www.cnil.fr/sites/default/files/2026-04/recommandation-pixels_de_suivi.pdf). Pouco depois, a autoridade independente de proteção de dados da Itália (&quot;Garante&quot;) publicou a [Provisão nº. 284](https://www.garanteprivacy.it/home/docweb/-/docweb-display/docweb/10241943) (a &quot;Disposição do Garante&quot;) em 17 de abril de 2026. Cada orientação, embora não seja juridicamente vinculativa, esclarece quando o consentimento é necessário e destaca a importância de práticas de consentimento adequadas para o rastreamento de pixels de email. Essa política pode afetar as práticas de envio para qualquer entidade que entregue emails a assinantes ao abrigo da legislação da UE aplicável em matéria de privacidade.
...
Os recursos do produto [!DNL Journey Optimizer B2B Edition] descritos aqui são componentes básicos que, configurados e operados adequadamente, podem ajudar a apoiar os esforços de conformidade do cliente. Os clientes são os únicos responsáveis por determinar e cumprir suas obrigações conforme as orientações e outras leis aplicáveis.
