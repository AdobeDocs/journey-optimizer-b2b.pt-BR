...
## Exibir a visualização do email {#display-preview}
...
1. Na página _[!UICONTROL Simular]_, selecione um perfil de pessoa na lista **[!UICONTROL Pessoas]** para usar na renderização do email.
   ...
   Se a lista _[!UICONTROL Pessoas]_ à esquerda estiver vazia, [adicione pessoas](#add-people) usando contatos.
...
## Ajustar as opções de exibição {#display-options}
...
## Adicionar pessoas à lista de perfis {#add-people}
...
1. Na caixa de diálogo _[!UICONTROL Adicionar pessoas para teste]_, digite o endereço de email completo do contato.
   ...
   Para adicionar vários contatos, insira os endereços separados por vírgulas.
