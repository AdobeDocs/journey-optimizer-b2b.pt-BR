...
+ Introdução {#get-started}
  ...
  + Configuração do ambiente {#admin-setup}
...
+ Gerenciamento de jornadas {#journeys}
  ...
  + Nós de jornada {#journey-nodes}
    ...
    + [Público-alvo de pessoa](./journeys/person-audience-nodes.md)
    ...
    + [Caminhos divididos variantes (Beta)](./journeys/variant-split-paths-nodes.md)
...
+ Conteúdo da jornada {#journey-content}
  ...
  + Canal de email {#email-channel}
    ...
    + [Gerar conteúdo de email](./content/generate-content-emails.md)
...
+ Contas {#accounts}
  ...
  + Listas de contas {#account-lists}
    ...
    + [Uso no jornada](./accounts/account-lists-journeys.md)
...
+ Gerenciamento de conteúdo {#content-management}
  ...
  + Páginas de destino {#landing-pages}
    ...
    + [Gerar conteúdo da página de aterrissagem](./content/generate-content-landing-pages.md)
  ...
  + [IA gerativa para conteúdo](./content/generative-ai-content.md)
