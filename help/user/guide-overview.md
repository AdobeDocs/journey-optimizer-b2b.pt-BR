...
Para obter uma lista completa de novos recursos e melhorias, consulte as [notas de versão](../user/release-notes/release-notes.md).

## Comece a explorar {#section-explore}

:::: landing-cards-container
:::
![Ícone de lista](https://cdn.experienceleague.adobe.com/icons/list-check.svg?lang=pt-BR)
...
Saiba como criar e gerenciar conteúdo para experiências personalizadas de clientes orquestradas por meio de jornadas.

[Explorar componentes do conteúdo](./content/content-components.md)
:::
...
[Explore jornadas](./journeys/journey-overview.md)
:::
