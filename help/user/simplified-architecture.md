...
&gt; <li>Esquema de referência: [Conta B2B - Esquema de conta de negócios XDM](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/schemas/create-schemas-for-b2b-data)
