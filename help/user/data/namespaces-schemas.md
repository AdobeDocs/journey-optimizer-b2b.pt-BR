...
A configuração do Journey Optimizer B2B edition na arquitetura simplificada inclui a configuração dos namespaces e esquemas do Experience Platform usados com fontes B2B. O utilitário de automação do Postman é necessário para gerar namespaces e esquemas B2B.
