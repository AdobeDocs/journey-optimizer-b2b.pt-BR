...
>[!NOTE]
>
>A ação _[!UICONTROL Alterar partição de pessoas no Marketo Engage]_ foi descontinuada para a versão 2025.10 e não está disponível na arquitetura simplificada do Journey Optimizer B2B edition.
