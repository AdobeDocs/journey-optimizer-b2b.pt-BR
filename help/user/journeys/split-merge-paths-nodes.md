...
| | [!UICONTROL Histórico de atividades] > [!UICONTROL Mensagem SMS] | Atividades de SMS associadas à jornada: <li>[!UICONTROL Link clicado em SMS]</li><li>[!UICONTROL SMS Devolvido]</li>Essas condições são avaliadas usando uma mensagem SMS selecionada anteriormente na jornada. |
