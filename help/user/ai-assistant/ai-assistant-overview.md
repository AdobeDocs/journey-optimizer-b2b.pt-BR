...
description: Acelere os fluxos de trabalho com o Assistente de IA - obtenha conhecimento sobre o produto, ajuda para a solução de problemas e insights operacionais para o Journey Optimizer B2B edition.
...
| Públicos-alvo da conta <br><br>**_Observação:_** O Assistente de IA B2B da AJO só pode responder perguntas de públicos-alvo para Públicos-alvo da conta, enquanto o Assistente de IA da Experience Platform só pode responder perguntas de Públicos-alvo da pessoa | <li>Contagem de público-alvo <li>Tipo de público-alvo (streaming ou lote) <li>Datas de criação/modificação <li>Status de ativação <li>Contagem de membros <li>Duplicar públicos <li>Pesquisa de nome e ID | <li>Sobreposições de públicos-alvo <li>Ativação de público-alvo <li>Auditoria <li>Criar/modificar <li>Rótulos <li>Tendências de qualificação de membros |
