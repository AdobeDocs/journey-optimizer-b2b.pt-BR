---
title: Painel de Envolvimento da Web
description: Analise o comportamento do visitante da Web com análises de exibição de página, insights regionais e segmentação do setor para informar sua estratégia de conteúdo.
...
| Coluna | Descrição |
| ------ | ----------- |
| Nome da página | O nome ou título da página da Web. |
| Total de visualizações | O número total de vezes que a página foi visualizada. |
| Visitantes conhecidos (%) | A porcentagem de exibições de página atribuídas aos visitantes conhecidos (identificados). |
| Visitantes desconhecidos (%) | A porcentagem de exibições de página atribuídas a visitantes desconhecidos (anônimos). |
...
Para baixar os dados, clique em **[!UICONTROL Baixar CSV]** na parte superior direita da tabela de dados.

![Tabela de principais exibições da página Exibir mais pop-up - Clique em Baixar CSV](./assets/web-engagement-dashboard-top-page-views-view-more.png){width="700" zoomable="yes"}
