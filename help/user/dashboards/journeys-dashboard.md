...
description: Acompanhe o desempenho da jornada de contas e pessoas com taxas de conclusão, métricas de envolvimento e análise da eficácia do canal no Journey Optimizer B2B edition.
...
O painel Visão geral das [jornadas de conta e pessoa](../journeys/journeys-overview.md) fornece um instantâneo abrangente das jornadas ativas. Os gráficos de círculo e de barra categorizam e quantificam as conclusões e atividades de envolvimento para que você possa avaliar a eficácia dos canais de email e SMS por meio das principais métricas de entrega e envolvimento.
...
![Visão geral das jornadas da pessoa](./assets/journey-overview-person.png){width="800" zoomable="yes"}
...
![Jornadas por tipo de compromisso](./assets/journeys-by-engagement-type.png){width="500"}
...
![Escolha Drill-through para acessar os dados de gráfico](./assets/journey-completion-rate-drill-through.png){width="700" zoomable="yes"}
