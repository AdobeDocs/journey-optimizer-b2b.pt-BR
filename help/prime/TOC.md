...
# Guia do usuário do Journey Optimizer B2B Prime {#prime}

+ [Documentação do Adobe Journey Optimizer B2B Prime](guide-overview.md)
+ [Configuração](./start/setup-prime.md)
...
+ Públicos-alvo {#audiences}
   + [Gerenciamento de públicos-alvo](./audiences/audience-management.md)
...
+ Administração {#admin}
   ...
   + Canais {#channels}
      + [Capacidade de entrega de email e configuração de canal](./admin/configuration-email-deliverability.md)
      + [Configuração do canal de SMS](./admin/configuration-channels-sms.md)
      + [Configuração do canal da Web](./admin/configuration-channels-web.md)
