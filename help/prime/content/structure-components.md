...
description: Use componentes de estrutura para email, página de aterrissagem e layouts de fragmento. Arraste colunas, defina estilos e configure a exibição móvel no Journey Optimizer B2B Prime.
...
![Arraste uma estrutura para a tela](../../assets/content-design-shared/content-design-add-structure.png){width="800" zoomable="yes"}
...
![Barra de ferramentas do componente de estrutura](../../user/assets/do-not-localize/toolbar-structure.png){width="150"}
...
| ![Selecionar coluna](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Selecionar uma coluna | Selecione uma coluna por número. Quando a coluna é selecionada, é possível aplicar configurações e estilos de coluna. |
...
![Exibir opções do componente de estrutura](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Conjunto de componentes da estrutura como cabeçalho](../../user/content/assets/structure-component-settings-header.png){width="600" zoomable="yes"}
...
![Não empilhar colunas em dispositivos móveis](../../user/content/assets/structure-component-settings-stack-columns.png){width="250"}
...
![Configurações da imagem de fundo do componente de estrutura com o seletor de ativos](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
![Visualização do posicionamento da imagem de fundo em um componente de estrutura](../../user/content/assets/structure-component-styles-background-image.png){width="250"}
...
![Barra de ferramentas da coluna](../../user/assets/do-not-localize/toolbar-column.png){width="500"}

| Ferramenta | Nome | Uso |
| ---- | ---- | ----- |
| — | Limpar coluna | Limpe o conteúdo na coluna. Veja a primeira ferramenta na figura da barra de ferramentas da coluna. |
| ![Habilitar conteúdo condicional](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Ativar conteúdo condicional | (Emails e fragmentos) Ative variantes condicionais para a coluna. |
| ![Selecione uma coluna](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Selecionar uma coluna | Selecione uma coluna por número. Quando a coluna é selecionada, é possível aplicar configurações e estilos. |
...
![Configuração de número de colunas](../../user/content/assets/structure-components-n-n-columns-number.png){width="650" zoomable="yes"}
...
![Redimensionar coluna](../../user/content/assets/structure-components-n-n-columns-resize.png){width="500" zoomable="yes"}
...
* **[!UICONTROL Imagem de plano de fundo]** - Mova o seletor de alternância para habilitar as configurações de imagem de plano de fundo.
  ...
  ![Configurações da imagem de plano de fundo da coluna no painel Estilos](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
No espaço de design visual, é possível acessar os componentes estruturais, incluindo colunas e conteúdo, usando a árvore de navegação. Clique no ícone da _[!UICONTROL Árvore de navegação]_ ( ![Ícone da árvore de navegação](../../user/assets/do-not-localize/icon-navigation-tree.svg) ) à esquerda para exibir a árvore.
