...
description: O Qualificador de vendas para Journey Optimizer B2B Prime fornece qualificação de prospecto de IA, fluxos de trabalho de saída, integração de CRM, tarefas e configurações de perfil para BDRs.
...
O Qualificador de Vendas está incluído com [!DNL Journey Optimizer B2B Prime], mas é um aplicativo separado dentro da Adobe Experience Platform.

![Tela inicial do Qualificador de Vendas](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}

### Account Qualification Agent {#account-qualification-agent}

O Account Qualification Agent (AQA) é o núcleo do qualificador de vendas. O AQA usa IA para ler suas contas e determinar quais estão prontas para a próxima etapa. Ele auxilia na pesquisa, elaboração de emails e contexto informado pelo CRM quando sua organização conecta o CRM (somente leitura).
...
![Tabela de clientes potenciais exibindo o status do cliente potencial e a última atividade para gerenciamento de clientes potenciais](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![Guia Visão geral do fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. Escolha **[!UICONTROL Iniciar do zero]** para escrever sua própria meta ou **[!UICONTROL Iniciar do modelo]** para usar um modelo salvo.
   ...
   ![Criar fluxo de trabalho de saída Iniciar do zero](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. Clique na seta para baixo para exibir a lista **[!UICONTROL Adicionar um filtro]** e selecione um filtro a ser aplicado.
   ...
   ![Criar filtros de direcionamento de fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}

1. Defina valores para o filtro.

1. Adicione mais filtros se precisar restringir o público.

   ![Criar filtros de direcionamento de fluxo de trabalho de saída adicionados com valores](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"}
...
![Cadência e prompts de ponto de contato gerados pelo fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"}
...
![Configurações do fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"}
...
![Fluxo de trabalho de saída adicionar prospetos](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![Emails gerados pela revisão do fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![Raciocínio de IA de email gerado pelo fluxo de trabalho de saída](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. No editor de email, clique em **[!UICONTROL Gerar com IA]**.
   ...
   ![Refinamento de email gerado pelo fluxo de trabalho de saída com IA](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![Fluxo de trabalho de saída selecionar e aprovar prospetos](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
![Página Tarefas mostrando a fila de tarefas e o painel de detalhes](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
>[!IMPORTANT]
>
>O acesso às integrações no Qualificador de Vendas requer `Sales Qualifier Admins` associação de grupo de usuários.
...
1. Na navegação à esquerda, expanda **[!UICONTROL Administração]** e selecione **[!UICONTROL Integrações]**.
   ...
   ![Página de integrações com os cartões de conexão do Salesforce e do Dynamics](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}
...
![Integrações - Knowledge Center](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"}
...
![Guia de configurações de email mostrando opções de conexão de email e configuração de assinatura de email](../../user/agents/assets/email-settings.png)
