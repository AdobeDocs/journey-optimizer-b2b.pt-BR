...
O Journey Optimizer B2B Prime envia mensagens do WhatsApp por meio da API da nuvem da Meta. Antes que os profissionais de marketing possam criar mensagens de WhatsApp para jornadas pessoais, um administrador de produto deve configurar um canal de WhatsApp.

![Fluxo de tarefas do WhatsApp para o Journey Optimizer B2B Prime](../../user/admin/assets/whatsapp-flow-diagram.png)
...
>[!IMPORTANT]
>
>Seu uso dos serviços de mensagens do WhatsApp está sujeito aos termos e condições do Meta. Ao acessar mensagens do WhatsApp por meio do Journey Optimizer B2B Prime, você reconhece que revisou e concorda em cumprir as [políticas de Negócios do Meta WhatsApp](https://www.whatsapp.com/legal/business-policy/).

## Limitações {#limitations}

Os seguintes limites se aplicam ao canal do WhatsApp:

* O Adobe Journey Optimizer B2B Prime **não é compatível com HIPAA e não está pronto para HIPAA**. Além disso, os fornecedores terceirizados não são cobertos pela BAA da Adobe. Os clientes são responsáveis por sua própria conformidade e validação do fornecedor.
...
Antes de enviar sua mensagem do WhatsApp, você deve configurar seu ambiente Journey Optimizer B2B Prime e conectá-lo com sua conta do WhatsApp.
...
1. Escolha a **[!UICONTROL Conta Comercial do WhatsApp]** que você deseja conectar às suas credenciais da API do WhatsApp.
   ...
   ![As credenciais da API de configurações do WhatsApp selecionam a conta comercial](../../user/admin/assets/config-whatsapp-channels-api-credentials-details.png){width="500" zoomable="yes"}
...
1. Testar as credenciais externamente - Verifique suas credenciais diretamente com a API do Meta para confirmar se o problema está relacionado às credenciais ou ao manuseio de credenciais do Journey Optimizer B2B Prime.
...
Os webhooks permitem que o Journey Optimizer B2B Prime receba mensagens de entrada, respostas de consentimento e notificações de entrega da sua conta comercial do WhatsApp. Configure webhooks para garantir o gerenciamento de consentimento e o rastreamento de mensagens adequados.
...
1. Digite a **[!UICONTROL Mensagem de resposta]** para enviar automaticamente quando uma mensagem recebida corresponder a uma palavra-chave nesta categoria.
   ...
   ![Webhooks de configurações do WhatsApp com palavras-chave de aceitação e mensagem de resposta](../../user/admin/assets/config-whatsapp-channels-webhooks.png){width="500" zoomable="yes"}
...
1. Copie os valores de **[!UICONTROL Verificar Token]** e **[!UICONTROL URL do Webhook]**.
   ...
   ![Configurações do WhatsApp do webhook para copiar a URL e verificar o token](../../user/admin/assets/config-whatsapp-channels-webhooks-copy-token-url.png){width="500" zoomable="yes"}
...
1. Digite o **[!UICONTROL número de telefone do remetente]** a ser usado para a entrega de mensagens.
   ...
   ![Detalhes de configuração do canal do WhatsApp](../../user/admin/assets/config-whatsapp-channels-general-create.png){width="500" zoomable="yes"}

1. (Não aplicável no momento para o Journey Optimizer B2B Prime) Para o **[!UICONTROL Campo de Execução do WhatsApp]**, selecione o atributo de perfil a ser usado como o número de telefone de prioridade quando vários números de telefone estiverem disponíveis para um destinatário.
